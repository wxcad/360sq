...
0
|| checktplrefresh('data/diy/./template/xinglan_s1//forum/viewthread.htm', './template/xinglan_s1/forum/viewthread_node.htm', 1565106231, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/xinglan_s1/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/xinglan_s1//forum/viewthread.htm', './template/xinglan_s1/forum/viewthread_fastpost.htm', 1565106231, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/xinglan_s1/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/xinglan_s1//forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1565106231, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/xinglan_s1/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/xinglan_s1//forum/viewthread.htm', './template/default/common/seditor.htm', 1565106231, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/xinglan_s1/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/xinglan_s1//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1565106231, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/xinglan_s1/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/xinglan_s1//forum/viewthread.htm', './template/default/common/upload.htm', 1565106231, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/xinglan_s1/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/xinglan_s1//forum/viewthread.htm', './template/default/common/seccheck.htm', 1565106231, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/xinglan_s1/', 'forum/viewthread')
...
<div class="z">
<a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a><em>&rsaquo;</em><a href="forum.php"><?php echo $_G['setting']['navs']['2']['navname'];?></a><?php echo $navigation;?> <em>&rsaquo;</em> <a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>"><?php echo $_G['forum_thread']['short_subject'];?></a>
</div>
</div>
...
<div class="forumlist_newthread" style="float:right;color:black;background:white;"><a id="post_reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复">发回帖</a></div>
</div>
<div class="threadfunc_div fix_top_menu">

<div class="seperator_div_1"></div>
<div class="func_share">
<img src="template/xinglan_s1/image/jian.png" />分享至：
<div class="func_share_btn">
<a href="misc.php?mod=chat&amp;action=qrcode&amp;tid=<?php echo $_G['tid'];?>" onclick="return false;"  id="k_share_to_chat"><i></i><img src="template/xinglan_s1/image/2.png" /></a>
<a href="javascript:void(0);" id="k_share_to_sina" onclick="posttoweibo();"><i></i></a>
<!-- <a href="misc.php?mod=chat&amp;action=code&amp;tid=<?php echo $_G['tid'];?>" onclick="showWindow('share_to_chat', this.href)" title="!connect_viewthread_share_to_chat!" id="k_share_to_chat"><i></i></a> -->
<a href="javascript:void(0);" id="k_qqshare" onclick="postToQzone();" title="!connect_viewthread_share_to_qzone!"><i></i></a>
<script type="text/javascript">
function posttoweibo(){
var pic = "";
jQuery("#postlist .first_post_table .pct img").each(function(){
pic += encodeURIComponent(jq(this).attr("src"))+'||';
})
var title = jQuery("#postlist .pppaaa h1 span").text();
var share_url = "http://service.weibo.com/share/share.php?url="+ encodeURIComponent(window.location.href) + "&pic=" + pic + "&title=" + encodeURIComponent(title)+"&appkey=";
...
var share_url = "http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url="+ encodeURIComponent(window.location.href) + "&pics=" + pic + "&title=" + encodeURIComponent(title);
window.open(share_url);
return false;
}
</script>
...
<div class="ct right">
<div id="pgta" class="pgs mbm cl <?php if($modmenu['thread']) { ?>pbm bbs<?php } ?>">
...
<?php } } else { if(!$_G['forum_thread']['is_archived']) { ?><div class="fatie"><a id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖">发新帖</a></div><?php } } if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
<div class="fatie r"><a id="post_reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复">发回帖</a></div>
<?php } ?>
...
<?php if(!IS_ROBOT) { } if($_G['setting']['close_leftinfo_userctrl']) { ?>
<span class="xg1 side_btn">
<?php if(!$close_leftinfo) { ?>
<a onclick="setcookie('close_leftinfo', 1);location.reload();" title="收起左侧" class="btn_s_close" href="javascript:;"><img src="template/xinglan_s1/image/control_l.png" alt="收起左侧" class="vm" /></a>
<?php } else { ?>
<a onclick="setcookie('close_leftinfo', 2);location.reload();" title="开启左侧" class="btn_s_open" href="javascript:;"><img src="template/xinglan_s1/image/control_r.png" alt="开启左侧" class="vm" /></a>
<?php } ?>
</span>
<?php } ?>
<h1 class="ts">
...
<span id="thread_subject"><?php echo $_G['forum_thread']['subject'];?></span>
  ...
  <?php if($_G['forum_thread']['authorid'] && $_G['forum_thread']['author']) { ?>
        <a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" target="_blank"  ><img src="<?php echo avatar($thread[authorid], middle, true);?>" class="avatar" style="
    padding-top: 10px; border-radius: 50%; padding:8px 0px; border="0" width="25" height="25" /></a>
   <?php } ?>
    </div>
<?php if($close_leftinfo && !$post['anonymous'] && $postshowavatars && $showavatars) { ?>

                    
                   <a href="javascript:;" class="zzee"><?php echo $post['author'];?></a> 
                    
<?php } $_self = $thread['author'] && $post['author'] == $thread['author'] && $post['position'] !== '1';?><?php if($_self ) { ?>
<?php echo $post['author'];?>&nbsp;&nbsp;<img class="authicn vm" id="authicon<?php echo $post['pid'];?>" src="<?php echo IMGDIR;?>/ico_lz.png" />
...
<em id="authorposton<?php echo $post['pid'];?>">发表于 <?php echo date('Y-m-d H:i:s',$thread[dateline])?></em>
...
<span class="pipe">|</span>
                        <span class="xi1 l"><?php echo $_G['forum_thread']['views'];?>人看过</span><span class="xi1 r"><?php echo $_G['forum_thread']['allreplies'];?>回复</span>
...
<div class="postaaa posta<?php echo $postcount;?>" id="post_<?php echo $post['pid'];?>" <?php if($_G['blockedpids'] && $post['inblacklist']) { ?>style="display:none;"<?php } ?>><?php $needhiddenreply = ($hiddenreplies && $_G['uid'] != $post['authorid'] && $_G['uid'] != $_G['forum_thread']['authorid'] && !$post['first'] && !$_G['forum']['ismoderator']);
...
<td class="plc"<?php if($close_leftinfo) { ?> style="width:100%"<?php } ?>>
    <span class="huifutoux"><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xi2 z" style="padding-right:10px;"><?php echo avatar($post['authorid'], 'small'); ?></a>
    <a href="home.php?mod=spacecp&amp;ac=follow&amp;op=add&amp;hash=<?php echo FORMHASH;?>&amp;fuid=<?php echo $post['authorid'];?>" id="followmod_<?php echo $post['authorid'];?>" title="收听TA" class="xi2 addflw"onclick="showWindow('followmod', this.href, 'get', 0);"></a>
    <a href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $post['authorid'];?>&amp;touid=<?php echo $post['authorid'];?>&amp;pmid=0&amp;daterange=2&amp;pid=<?php echo $post['pid'];?>&amp;tid=<?php echo $post['tid'];?>" onclick="showWindow('sendpm', this.href);" title="发消息" class="xi2 fxx"></a>
</span>
<div class="pi"<?php if($close_leftinfo && !$post['anonymous'] && $postshowavatars && $showavatars) { ?>style="height:25px" <?php } ?>>
...
<div class="authi">
<?php if($close_leftinfo && !$post['anonymous'] && $postshowavatars && $showavatars) { } $_self = $thread['author'] && $post['author'] == $thread['author'] && $post['position'] !== '1';?><?php if($_self ) { ?>
<?php echo $post['author'];?>&nbsp;&nbsp;<img class="authicn vm" id="authicon<?php echo $post['pid'];?>" src="<?php echo IMGDIR;?>/ico_lz.png" />
<?php } else { if(!$post['anonymous'] && $_G['cache']['groupicon'][$post['groupid']]) { ?>
<img class="authicn vm" id="authicon<?php echo $post['pid'];?>" src="<?php echo $_G['cache']['groupicon'][$post['groupid']];?>" />
<?php } else { ?>
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_endline'][$postcount])) echo $_G['setting']['pluginhooks']['viewthread_endline'][$postcount];?>
            ...
            <div class="loulou">
                    <span class="huifu"><span class="shuz">楼层</span><span class="wenz"></span> </span>
<div id="fj" class="y">
...
<?php if($modmenu['thread']) { ?>
<div class="xi2 mbm pbm bbs" id="yunyun">
...
<?php if(!$_G['forum_thread']['is_archived']) { } if($allowpostreply && !$_G['forum_thread']['archiveid']) { } ?>
</div>
