...
0
|| checktplrefresh('./template/xinglan_s1/common/header.htm', './template/default/common/header_common.htm', 1565105292, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/xinglan_s1', 'common/header_forum_index')
|| checktplrefresh('./template/xinglan_s1/common/header.htm', './template/default/common/header_qmenu.htm', 1565105292, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/xinglan_s1', 'common/header_forum_index')
;?>
