...
<div class="piao">
            <div class="ac<?php echo $value['classid'];?> pp">
<em>（<?php echo $value['clicknum'];?>票）</em>
</div>
            </div>
            </a>
</td>
...
<h3 class="mbm xs1">
刚表态的朋友 (<a href="javascript:;" onclick="show_click('<?php echo $idtype;?>', '<?php echo $id;?>', '<?php echo $key;?>')"><?php echo $clicknum;?> 人</a>)
