...
block_get('19,20');?><?php include template('common/header'); ?><link rel="stylesheet" type="text/css" href="template/xinglan_s1/common/index.css"/>

<!--[diy=diy1]--><div id="diy1" class="area"><div id="framexI8gbE" class="sydiy1 frame move-span cl frame-1-1"><div id="framexI8gbE_left" class="column frame-1-1-l"><div id="framexI8gbE_left_temp" class="move-span temp"></div><?php block_display('19');?></div><div id="framexI8gbE_center" class="column frame-1-1-r"><div id="framexI8gbE_center_temp" class="move-span temp"></div><?php block_display('20');?></div></div></div><!--[/diy]-->
...
<dt><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="今日"> 今日新增 <strong class="jinrib">(<?php echo $forum['todayposts'];?>)</strong></em><?php } ?></dt>
<?php if(empty($forum['redirect'])) { ?><dd><em>主题: <?php echo dnumber($forum['threads']); ?></em>, <em>帖数: <?php echo dnumber($forum['posts']); ?></em></dd><?php } if($forum['description']) { ?><dd><?php echo $forum['description'];?></dd><?php } ?>
<dd>
...
<td>
<h2><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="今日"> 今日新增 <strong class="jinrib">(<?php echo $forum['todayposts'];?>)</strong></em><?php } ?></h2>
...
<div class="bm_h cl bkh<?php echo $cat['fid'];?>">
...
<dl<?php if(!empty($forum['extra']['iconwidth']) && !empty($forum['icon'])) { ?> style="margin-left: <?php echo $forum['extra']['iconwidth'];?>px;"<?php } ?>>
<dt><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="今日"> 今日新增 <strong class="jinrib">(<?php echo $forum['todayposts'];?>)</strong></em><?php } ?></dt>
<dd class="dret"><?php if($forum['description']) { ?><p class="xg2"><?php echo $forum['description'];?></p><?php } ?></dd>
<?php if(empty($forum['redirect'])) { ?><dd><em><i>主题: </i><?php echo dnumber($forum['threads']); ?></em>, <em><i>帖数: </i><?php echo dnumber($forum['posts']); ?></em></dd><?php } ?>
<dd class="zyzy">
<?php if($forum['permission'] == 1) { ?>
私密版块
<?php } else { if($forum['redirect']) { ?>
...
<a href="forum.php?mod=redirect&amp;tid=<?php echo $forum['lastpost']['tid'];?>&amp;goto=lastpost#lastpost" class="xi2"><?php echo cutstr($forum['lastpost']['subject'], 30); ?></a> <cite><?php echo $forum['lastpost']['dateline'];?> <?php if($forum['lastpost']['author']) { ?>55 <?php echo $forum['lastpost']['author'];?><?php } else { ?><?php echo $_G['setting']['anonymoustext'];?> 33<?php } ?></cite>
<?php } else { ?>
<a href="forum.php?mod=redirect&amp;tid=<?php echo $forum['lastpost']['tid'];?>&amp;goto=lastpost#lastpost">最后发表: <?php echo $forum['lastpost']['dateline'];?> 22</a>
<?php } } else { ?>
从未
<?php } } ?>
</dd>
...
<h3>
<strong class="biti"><a href="home.php?mod=space&amp;do=friend&amp;view=online&amp;type=member">在线会员</a></strong>
