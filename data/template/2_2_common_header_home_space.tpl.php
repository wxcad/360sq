...
0
|| checktplrefresh('./template/xinglan_s1/common/header.htm', './template/default/common/header_common.htm', 1565105375, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/xinglan_s1', 'common/header_home_space')
|| checktplrefresh('./template/xinglan_s1/common/header.htm', './template/default/common/header_qmenu.htm', 1565105375, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/xinglan_s1', 'common/header_home_space')
;?>
