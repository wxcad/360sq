...
0
|| checktplrefresh('./template/xinglan_s1/common/header.htm', './template/default/common/header_common.htm', 1565106313, '2', './data/template/2_2_common_header_portal_view.tpl.php', './template/xinglan_s1', 'common/header_portal_view')
|| checktplrefresh('./template/xinglan_s1/common/header.htm', './template/default/common/header_qmenu.htm', 1565106313, '2', './data/template/2_2_common_header_portal_view.tpl.php', './template/xinglan_s1', 'common/header_portal_view')
;?>
